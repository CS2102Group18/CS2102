		...
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				<form>
					...
					<div class="form-group row">
						<label for="email" class="col-4 col-form-label">Email Test</label>
						<div class="col-8">
							<input id="email" name="emailInput" placeholder="Email" class="form-control here" required="required" type="text">
						</div>
					</div>
					<div class="form-group row">
