					...
					<div class="py-1 d-flex align-items-center justify-content-end">
						<ul class="navbar-nav d-flex flex-row">
							<div class="dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									<a class="dropdown-item" href="#Fashionddl">Fashion</a>
									<a class="dropdown-item" href="#Technologyddl">Technology</a>
									<a class="dropdown-item" href="#Gamesddl">Games</a>
									<a class="dropdown-item" href="#Foodddl">Food</a>
									<a class="dropdown-item" href="#Musicddl">Music</a>
									<a class="dropdown-item" href="#Photographyddl">Photography</a>
									<a class="dropdown-item" href="#Handicraftddl">Handicraft</a>
									<a class="dropdown-item" href="#Communityddl">Community</a>
								</div>
							</div>
							<li class="nav-item">
